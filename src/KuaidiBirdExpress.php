...
class KuaidiBirdExpress
{

    protected $url = 'https://api.kdniao.com/Ebusiness/EbusinessOrderHandle.aspx';
     ...
     */
    public function query($tracking_code = '', $shipping_code = '')
    {
        ...
        $param = [
            ...
            'DataType'    => '2',
            'DataSign'    => $this->encrypt($request, $this->app_key),
        ];
    ...
    {
        return urlencode(base64_encode(md5($request.$key)));
    }
