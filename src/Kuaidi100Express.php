...
class Kuaidi100Express
{
    protected $url = "https://poll.kuaidi100.com/poll/query.do";
     ...
     */
    public function query($tracking_code = '', $shipping_code = '', $phone = '')
    {
        ...
        $request['customer'] = $this->app_id;
        $request['sign'] = $this->encrypt($request['param']);
    ...
    {
        return strtoupper(md5($param . $this->app_key. $this->app_id));
    }
